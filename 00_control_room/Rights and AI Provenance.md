...
## AI involvement ledger
| Date | Song | What | Human/AI split |
|---|---|---|---|
| 2026-08-18 | — | Catalog, rankings, briefs written by Claude from Jeff's source material. Zero AI-generated lyrics, melodies, or audio. All quoted lyrics are Jeff's verbatim. | Analysis: AI. All creative material: 100% Jeff (and collaborators). |
...
- Better Than Now: composition by **Sean (Stalemate bassist)**. No external use without his consent.
- Long Long Drive: **Jeff's, confirmed** — eligible for the proposed Suno experiment once approved.
- UNK-0001..0013: **Dustin Duffy's songs** (Stalemate Split, active as of Aug 2025). Collaborator material.
- Trailer Swift: Jeff's solo project; compositions are Taylor Swift covers — never uploaded to AI services.
- Andrea: Dustin holds an identical lyric doc — clarify casually whether old co-write.

## AI landscape update — 2026-08-20 (researched)
Warner settled with Suno (Nov 2025); UMG settled with Udio (Oct 2025); Sony suits vs both continue (rulings expected summer 2026). Suno free tier lost downloads; ToS says users generally do not OWN generated output; no indemnification. Streaming platforms now tag/demonetize AI uploads (Deezer, Spotify verification, Apple filtering). HOUSE POSITION UNCHANGED AND VALIDATED: AI output is a private decision aid only, never released as Jeff Story material — which keeps Jeff's releases fully human, own-able, and platform-safe. Udio ruled out (walled garden, no export). Voice cloning wall stays up. Full analysis: AI Music Services — Field Guide 2026.
