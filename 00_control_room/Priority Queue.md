...
*StoryBoard #4 honesty 2026-08-23: default import is Jeff Story + Rad Dad repertoire + recorded Rad Dad plays in `setlist_ready` — not an empty list, not a fourth WIP, not an invented setlist. Still these three songs. Still no new priorities.*
