...
*Catalog rows are not the official set 2026-08-27: Vault default-live stays a catalog slice; Show Night owns official sets; dashboard reuses data/app_api.json. Still these three songs. Still no new priorities.*
