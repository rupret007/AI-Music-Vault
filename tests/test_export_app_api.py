...
class ExportHonestyTests(unittest.TestCase):
    ...
    def test_field_map_matches_importer(self):
        ...
        self.assertIn("StoryBoard #20", mapping["inspected"])
        ...
        self.assertIn("catalog rows are not the official set", mapping["inspected"])
        self.assertTrue(mapping["catalog_rows_are_not_the_official_set"])
        self.assertTrue(mapping["vault_default_live_is_not_the_official_set"])
        self.assertTrue(mapping["show_night_owns_official_sets"])
        self.assertTrue(mapping["ops"]["catalog_rows_are_not_the_official_set"])
        self.assertTrue(mapping["ops"]["show_night_owns_official_sets"])
        ...
        self.assertTrue(mapping["show_night_official_set_is_owner_only"])
    ...
    def test_live_repo_default_import_matches_storyboard_planner(self):
        ...
        self.assertIn("StoryBoard #20", api["storyboard"]["inspected"])
        ...
        self.assertIn("catalog rows are not the official set", api["storyboard"]["inspected"])
        self.assertTrue(api["storyboard"]["show_night_binds_official_set_dump"])
        self.assertTrue(api["storyboard"]["catalog_rows_are_not_the_official_set"])
        self.assertTrue(api["storyboard"]["vault_default_live_is_not_the_official_set"])
        self.assertTrue(api["storyboard"]["show_night_owns_official_sets"])
